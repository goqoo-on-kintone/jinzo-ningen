const getRecords = async ({ appId, query }) => {
...
const updateStatus = async ({ appId, recordId, action }) => {
  await page.evaluate(
...
const postRecord = async (appId, record) => {
...
const postRecords = async (appId, records) => {
...
const deleteRecords = async (appId, recordIds) => {
  await page.evaluate(
